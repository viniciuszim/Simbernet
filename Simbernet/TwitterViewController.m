...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *URLFoto = [NSString stringWithFormat:@"%@%@%@%@%@", url_base_arquivos, base_contexto, HTTP_Repositorio, HTTP_PathFotosUsuarios, tweet.usuario.foto];
    cell.profileImage.image = nil;
    [cell.profileImage setImageURL:[NSURL URLWithString:[Utils cleanURL:URLFoto]]];
    // Arredondo a imagem
